...
if (isset($_POST['request_submit'])) {
  ...
  $q ="INSERT INTO hospital(Hospital_Name,Address,Blood_Group,Mobile_Number,City,file)
   VALUES ('$Hospital_Name','$Address','$Blood_Group','$Mobile_Number','$City','$file')";
...
<script typotica="" type="text/javascript">( function($){
        ...
        <div class="container-fluid" style="background-image: url(./img/redn.jpg) background-size: cover; background-repeat: no-repeat;">          
         <div class="row">
                <div class="col-sm-6 offset-md-3">
                    <div class="request-form">
                        <div class="submit-info text-center"><h2>Hospital Blood Request</h2></div> <BR>                    
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group text-" action="code_exec.php" onsubmit="return validateForm()" >
