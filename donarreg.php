...
echo $Address = $_POST['Address'];
 ...
 echo $Age = $_POST['Age'];
echo $When_Need_Blood = $_POST['When_Need_Blood'];
echo $Blood_Unit = $_POST['Blood_Unit'];
echo  $Email = $_POST['Email'];
 
  
  
 echo $Mobile_Number = $_POST['Mobile_Number'];
echo $Hospital_Name = $_POST['Hospital_Name'];
...
<script typotica="" type="text/javascript">( function($){
        ...
        <div class="container-fluid" style="background-image: url(./img/12.jpg); height: auto; width: auto; background: cover;" >
            <div class="row">
                        ...
                        <form action="" method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-12 text-center">
                                    <button type="submit" name="request_submit" class="btn mt-30 btn-default btn-center">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
